...
AS 	
	...
	ELSE
		BEGIN
			SELECT * FROM AUDI_ESM WHERE CODI_ESM = 'DATOSVACIOSSIEMPRE'
		END
...
-- SE LE AGREGO LA CONSULTA DE LA TABLA TEMPORAL PARA SABER SI HAY DATOS O NO LOS HAY Y ASI RETORNAR UN ARRAY VACIO