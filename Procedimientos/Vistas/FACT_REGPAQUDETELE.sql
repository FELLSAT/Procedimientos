CREATE OR REPLACE VIEW FACT_REGPAQUDETELE
 -- =============================================      
...
AS 
    ...
    INNER JOIN FORMULAS  ON  MOVI_CARGOS.NU_NUME_MOVI = FORMULAS.NU_NUME_MOVI_FORM
    ...
    RIGHT JOIN  FACTURAS_CONTADO    ON  R_REGISTRO_CONV.NU_NUME_FACO_RECO = FACTURAS_CONTADO.NU_NUME_FACO
    AND MOVI_CARGOS_PAQU.NU_NUME_FACO_MOVI =  FACTURAS_CONTADO.NU_NUME_FACO
