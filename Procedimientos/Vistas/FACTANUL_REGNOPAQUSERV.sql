CREATE OR REPLACE VIEW FACTANUL_REGNOPAQUSERV
 -- =============================================      
...
AS 
    ...
    INNER JOIN REGIMEN ON R_PAC_EPS.CD_CODI_REG_RPE = REGIMEN.CD_CODI_REG
    ...
    INNER JOIN R_REGISTRO_CONV    
        ON CONVENIOS.NU_NUME_CONV = R_REGISTRO_CONV.NU_NUME_CONV_RECO
    INNER JOIN REGISTRO    
        ON R_REGISTRO_CONV.NU_NUME_REG_RECO = REGISTRO.NU_NUME_REG
        AND  PACIENTES.NU_HIST_PAC =  REGISTRO.NU_HIST_PAC_REG
    ...
    INNER JOIN SERVICIOS     
        ...
        ON FACTURAS_CONTADO.NU_NUME_FACO = FACTURAS_ANULADAS.NU_NUME_FAC__FACA
