CREATE OR REPLACE VIEW FACT_REGPAQUDETSERV
 -- =============================================      
 -- Author:  
 -- =============================================
AS 
    SELECT PACIENTES.NU_HIST_PAC HISTORIA_PAC  ,
        ...
        CASE MOVI_CARGOS.NU_NUME_PAQU_MOVI
            WHEN 0 THEN MOVI_CARGOS.NU_NUME_MOVI
            ELSE MOVI_CARGOS.NU_NUME_PAQU_MOVI
        END GRUPO_PAQUETE  ,
    ...
    INNER JOIN FACTURAS_CONTADO    
        ON MOVI_CARGOS_PAQU.NU_NUME_FACO_MOVI = FACTURAS_CONTADO.NU_NUME_FACO
        ON MOVI_CARGOS.NU_NUME_PAQU_MOVI = PAQUETES.NU_NUME_PAQU
        AND R_REGISTRO_CONV.NU_NUME_FACO_RECO = FACTURAS_CONTADO.NU_NUME_FACO
