CREATE OR REPLACE VIEW FACT_REGNOPAQUSERV
 -- =============================================      
 -- Author:
 -- =============================================
AS 
    SELECT PACIENTES.NU_HIST_PAC HISTORIA_PAC  ,
        ...
        PACIENTES.NO_NOMB_PAC || ' ' || PACIENTES.NO_SGNO_PAC || ' ' || PACIENTES.DE_PRAP_PAC || ' ' || PACIENTES.DE_SGAP_PAC NOMBRE_PAC  ,
    ...
    INNER JOIN SERVICIOS    
        ...
        AND FACTURAS_CONTADO.NU_NUME_FACO = R_REGISTRO_CONV.NU_NUME_FACO_RECO
