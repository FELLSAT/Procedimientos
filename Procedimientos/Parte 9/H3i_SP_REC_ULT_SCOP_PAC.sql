CREATE OR REPLACE PROCEDURE H3i_SP_REC_ULT_SCOP_PAC
 -- =============================================      
   ...
   OPEN  cv_1 FOR
      SELECT * 
        ...
        FROM HIST_SCOP 
               ...
               LEFT JOIN HIST_SCOP_OBS    ON NU_NUME_HS_HSO = NU_NUME_HS
       WHERE  NU_HIST_PAC = v_PACIENTE
        ORDER BY FE_FECH_INGR_HS DESC )
        WHERE ROWNUM <= 1 ;
