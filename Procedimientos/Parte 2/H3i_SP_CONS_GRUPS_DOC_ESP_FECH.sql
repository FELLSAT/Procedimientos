CREATE OR REPLACE PROCEDURE H3i_SP_CONS_GRUPS_DOC_ESP_FECH
 -- =============================================      
   ...
   OPEN  cv_1 FOR
      SELECT NU_GRUP_EST_DOC_ESP ,
       ...
       WHERE  CD_CODI_MED_DOC_GEDE = v_CD_CODI_MED_DOC_GEDE
                ...
                AND ( v_FECHA_INICIO_GEDE BETWEEN FECHA_INICIO_GEDE AND FECHA_FINAL_GEDE )
        ORDER BY FECHA_INICIO_GEDE ;

EXCEPTION 
    WHEN OTHERS 
        THEN RAISE_APPLICATION_ERROR(SQLCODE,SQLERRM);
END H3i_SP_CONS_GRUPS_DOC_ESP_FECH;