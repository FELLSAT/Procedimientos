CREATE OR REPLACE FUNCTION POSICIONCARACTERNONUM
 -- =============================================      
 -- Author:  FELIPE SATIZABAL
 --  Esta funcion captura la posicion del primer caracter no numerico
 -- =============================================
(
   IN_CADENA VARCHAR2
)
...
BEGIN
   LOOP
      ...
      IF(NVL('','###')<>NVL(V_CADENA,'###')) THEN 
         ...
         IF(V_CODIGO_ASCII >= 65 AND V_CODIGO_ASCII <= 90 OR 
            V_CODIGO_ASCII >= 97 AND V_CODIGO_ASCII <= 122) THEN
