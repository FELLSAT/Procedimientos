CREATE OR REPLACE PROCEDURE H3i_SP_REP_PRES_ESTADO
 -- =============================================      
...
BEGIN
    ...
    OPEN  cv_1 FOR
        SELECT PRES_MOVIMIENTO.CD_CODI_MED_PM ,
            ( SELECT NO_NOMB_MED 
              FROM MEDICOS 
              WHERE  CD_CODI_MED = PRES_MOVIMIENTO.CD_CODI_MED_PM AND ROWNUM <= 1 ) NOMBREMEDI  ,
        ...
        WHERE  PRES_ESTADOS.ID_ESTADO = v_ID_ESTADO
