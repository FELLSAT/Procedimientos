CREATE OR REPLACE PROCEDURE H3i_OBTENER_ENCAB_FACT_CREDITO
 -- =============================================      
...
BEGIN
    ...
    OPEN CV_1 FOR
        SELECT DISTINCT  EPS.NO_NOMB_EPS Administradora,
            ...
            NU_DOCU_PAC NumDoc,
            FE_FECH_FACO Fecha,
            (  DE_PRAP_PACV ||' '||DE_SGAP_PAC||' '||NO_NOMB_PAC||' '||NO_SGNO_PAC) Paciente,
            CARNE Carne,
            CASE NU_SEXO_PAC
            ...
            ( SELECT d.NO_NOMB_DPTO
              FROM MOVI_CARGOS MC
              INNER JOIN dbo.LUGAR_ATENCION LA
            ...
            SUM(VL_UNID_MOVI) TotalCargos, -- VL_TOTA_FACO TotalCargos,
        ...
        WHERE NU_AUTO_FCCR_FACO = V_NU_NUME_FACO
        GROUP BY NO_NOMB_EPS, CD_CODI_CONV, CD_NOMB_CONV, 
             CD_NIT_EPS, NU_HIST_PAC, NU_DOCU_PAC, NU_TIPD_PAC,
             FE_FECH_FACO, DE_PRAP_PAC , DE_SGAP_PAC, NO_NOMB_PAC,
             NO_SGNO_PAC, CARNE, NU_SEXO_PAC, FE_NACI_PAC, CAJERO, 
             DE_DIRE_PAC, VL_TOTA_FACO, VL_RECU_FACO, VL_ABON_FACO,
             VL_SUBS_FACO, DE_OBSE_FACO, VL_RECA_FACO, VL_FINA_FACO, 
