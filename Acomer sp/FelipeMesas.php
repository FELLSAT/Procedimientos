			...
			<div class="main-content-select-puestos">
				...
				<div class="content-select-puestos mrg__bottom-30">
					<div class="input-group">
						...
						<!--MAXIMO DE PUESTOS SEGUN LA CANTIDAD REGISTRADA EN BD-->
						<input type="text" name="selectPuestos" class="form-control input-number" value="1" min="1" max="<?=$maxpuestos; ?>"> 
						<span class="input-group-btn">
...
<?php $this->endBody() ?>
	...
	<script>
		var estadoMesa = "<?php echo $estadomesa; ?>";
		var codigoMesa = "<?php echo $codigomesa; ?>";
		var puestoMesa = "<?php echo $maxpuestos; ?>";
...
<!--SI LA MESA YA ESTA oCUPADA CARGAR LAS CLASES DE #NPUESTOS-->
<!---->